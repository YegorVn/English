  ...
  return (
    <Container className="navbar-container mt-3">
      <div className="navbar-wrapper d-flex flex-lg-row flex-wrap justify-content-between align-items-center">
        <div className="navbar-links text-xs bold uppercase px-3 pt-3 pb-3 pb-lg-0 pt-lg-0 d-flex flex-column flex-lg-row flex-wrap 
          justify-content-between align-items-center col-12 col-lg-8 col-xl-9">
          {["Essays", "Grammar", "Pronounce"].map((el, index) => {
            return (
              <Link
                key={el}
                className={
                  "navbar-links__link pt-2 pb-2 col-12 col-lg-5 col-xl-3 text-center " +
        ...
        <button
          className="user-info col-12 col-lg-4 col-xl-3 mt-5 mt-lg-0"
          onClick={() => setUserInfo(!userInfo)}
        >
          <div className="user-info-content col-12 col-lg-11 col-xl-11 ms-lg-auto d-flex align-items-center px-2">
            <img src={user} className="user-info-content__icon " alt="" />
            <div className="user-info-text-block ms-4">
              <div className="user-info-text-block__name text-xxs">
                Дмитрий Иванович
              </div>
              <div className="user-info-text-block__statuse text-xxxs">
                Ученик
              </div>
            </div>
